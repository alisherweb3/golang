...
func main() {
  flag.parse()
  if len(flag.Args()) == 0 {
    fmt.Println("usage: stats filename\n")
    return
  }
  ...
  fmt.Println("Median:", mmedianvalue(data))
  fmt.Println("Variance:", variance(data))
  fmt.Println("Standart Deviation:", math.Sqrt(variance(data)))
}
